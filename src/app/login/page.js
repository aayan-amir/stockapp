...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-navy-DEFAULT px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-accent/50 text-sm mt-1">Enter your access PIN to continue</p>
        </div>
